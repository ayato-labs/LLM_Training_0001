# ADR-0028-advanced-pretraining-optimizations: Advanced System Optimizations (Liger Kernel, torch.compile, use_reentrant)
...
3. **Non-Reentrant Gradient Checkpointing**:
...
- **Memory Efficiency**: 40-60% VRAM saving from Liger Kernel on Linux deployments.
